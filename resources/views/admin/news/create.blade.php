...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="" id="createNewForm" name="createNewForm" method="post">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea rows="5" name="description" id="description" cols="30" rows="10" class="summernote">
                                        </textarea>
                                    <p></p>
                                </div>
                            </div>
...
@section('customJs')
    <script>
        $("#createNewForm").submit(function(event) {
